export class Graph {
    constructor() {
        ...
        this.optimal_weighted_degrees = new Map();
    ...
    get_cumulative_edge_weights() {
        return this.cumulative_edge_weights;
    }

    get_cumulative_optimal_weighted_degrees() {
        return this.cumulative_optimal_weighted_degrees;
    }

    get_optimal_weighted_degrees() {
...
// Create a unit test for the Graph class
