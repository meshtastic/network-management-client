...
/**
 * 
 * This message is handled by the Admin module and is responsible for all
 * settings/channel read/write operations. This message is used to do settings
 * operations to both remote AND local nodes. (Prior to 1.2 these operations
 * were done via special ToRadio operations)
 */
